       ...
       {this.state.tickets.map((tickets, i) => {
         return (
           <tr style = {{"width": "100%"}} key={i}>
             ...
             <td style = {{"width": "25%"}} className="overflow-hidden"> {tickets.description} </td>
             <td style = {{"width": "10%"}}> {tickets.assignee.username} <p><small>last update:{tickets.last_update} GMT</small></p> </td>
             <td style = {{"width": "10%"}}>
               <Delete   handleDelete = {this.handleDelete} handleTicket = {this.props.handleTicket} addTickets = {this.addTicket} getTickets={this.getTickets} baseUrl={this.props.baseUrl} ticket={tickets.id} />
               </td>
