    ...
    return (
      <div>
        <Navbar bg="light" expand="lg">
          <Navbar.Brand onClick={() => this.handleTicket()}>
            Click Tix
          </Navbar.Brand>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            {this.props.session === true ? (
              <Nav className="mr-auto">
                <Nav.Link onClick={() => this.handleTicket()}>
                  My Tickets
                </Nav.Link>
                <Nav.Link onClick={() => this.handleNew()}>New Ticket</Nav.Link>
                <Nav.Link onClick={() => this.handleAll()}>
                  All Tickets
                </Nav.Link>
                <Nav.Link onClick={() => this.handleSubmitLogout()}>
                  Sign-Out
                </Nav.Link>
              </Nav>
            ) : null}
